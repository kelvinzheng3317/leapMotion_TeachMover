...
class IK_wrist
    ...
    FindX(b As Decimal, s As Decimal, e As Decimal, p As Decimal):
        # <Input>
    ...
    FindY(b As Decimal, s As Decimal, e As Decimal, p As Decimal):
        # <Input>
        # b, s, e - step value of base, shoulder, elbow
        # p - pitch
        # <Output>
    ...
    FindZ(s As Decimal, e As Decimal, p As Decimal):
        # <Input>
        # b, s, e - step value of base, shoulder, elbow
        # p - pitch
        # <Output>
    ...
    FindRoll(wr As Decimal, wl As Decimal):
        ' <Input>
